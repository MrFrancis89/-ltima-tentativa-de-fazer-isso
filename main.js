...
const VERSAO_ATUAL = "v6.2.3";

const releaseNotes = {
    "v6.2.3": `StockFlow Pro v6.2.3

- Melhorias na interface: paleta de cores atualizada e remoção de emojis.
...
- Tooltips nos botões Fixar e Apagar.`,
    "v5.3.0": `v5.3.0
